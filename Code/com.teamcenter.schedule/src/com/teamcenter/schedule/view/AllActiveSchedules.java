...
public class AllActiveSchedules {
	...
	public AllActiveSchedules(TCSession session) {
	...
	//	new Nat_explore().nat_tableDisplay(composite1_table,dataList);
...
// Using SavedQueryService we are searching created schedule from TC
